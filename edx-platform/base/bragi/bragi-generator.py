...
for color in palette_definitions:
        src = 'lms/static/sass'
        dst = '../../bragi-{color}/bragi-{color}/lms/static/sass'.format(color = color[1:])
        try:
            shutil.rmtree(dst)
        ...
        themable_file = '../../bragi-{color}/bragi-{color}/lms/static/sass/partials/lms/theme/_variables-extras.scss'.format(color = color[1:])
